...
const char* ssid = "AndroidAP";// enter wifi name 
const char* password = "kohlivirat";// enter password here
...
//  client.println("Content-Type: text/html");
  ...
  client.println("<p align=middle><center><font size =7 color=blue> Button1: ");
  if(switch1 == LOW) 
  {  client.print("ON ");
